...
export function janyaRaagaToEnglishMuthu(raaga: JanyaRaaga) {
  switch (raaga) {
    ...
    case JanyaRaaga.Vasanthamalai:
      return 'Vasanthamalai';
    case JanyaRaaga.Vedhaandhagamana:
      return 'Vedhāndhagamana';
    ...
    case JanyaRaaga.Gambheeravani:
      return 'Gambheeravani';
    case JanyaRaaga.Lalithagaandharva:
      return 'Lalithagāndharva';
